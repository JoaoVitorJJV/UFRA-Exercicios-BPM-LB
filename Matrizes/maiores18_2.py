print('________________MAIORES DE 18 2___________________')
...
while loop:
    ...
    porcentagem_maiores_idade = (pessoas_listadas / valor_maximo) * 100 
    ...
    print('{:.0f}% do total'.format(porcentagem_maiores_idade))
